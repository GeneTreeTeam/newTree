...
function wrapStack (...components) {
  return components.reduce((wrapStack, component) => [
    ...wrapStack,
    ...[].concat(component.wrapStack || component.displayName || component.name || 'Anonymous'),
  ], [])
}
...
wrapStack.trueNameFor = (Component) => {
  return [...(Component.wrapStack || [])].reverse()[0] || Component.displayName || Component.name
}
